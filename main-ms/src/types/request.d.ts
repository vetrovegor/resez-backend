...
export type RequestWithParamsAndBodyAndUser<P, B> = RequestWithParamsAndBody<
    P,
    B
> & { user: UserTokenInfo };

export type RequestWithParamsAndQuery<P, Q> = RequestWithParams<P> &
    RequestWithQuery<Q>;

export type RequestWithParamsAndQueryAndUser<P, Q> = RequestWithParams<P> &
    RequestWithQuery<Q> & { user: UserTokenInfo };